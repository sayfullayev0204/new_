...
class Category(TranslatableModel):
    ...
    def __str__(self):
        return self.safe_translation_getter("name", any_language=True) or "No Title"
    class Meta:
        verbose_name = "Category"
        verbose_name_plural = "Category"

class Yonalish(TranslatableModel):
    yonalish = models.ForeignKey(Category, on_delete=models.CASCADE)
    translations = TranslatedFields(
        sarlavha=models.CharField(max_length=255, verbose_name="Sarlavha"),
        matn=models.TextField(verbose_name="Matn")
    )
    ...
    main_image = models.ImageField(upload_to='images/', null=True, blank=True, verbose_name="Asosiy rasm")
    date = models.DateTimeField(auto_now_add=True, verbose_name="Sana")
    video_file = models.FileField(upload_to='videos/', null=True, blank=True, verbose_name="Video fayl")
...
class YonalishImage(models.Model):
    article = models.ForeignKey(Yonalish, related_name='images', on_delete=models.CASCADE, verbose_name="Yonalish")
    image = models.ImageField(upload_to='images/', verbose_name="Qo'shimcha rasm")
